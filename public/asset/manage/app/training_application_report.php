...
<head>
  ...
  <title>Mission Shakti | Training Application Report</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Training Application Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Training Application Report</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      ...
                      $result = $application->get_training_application_report();
                      $i=0;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="training_application_list?district=<?php echo $row['district'];?>" class="btn btn-tbl-edit btn-xs btn-primary">
