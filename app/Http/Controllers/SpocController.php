...
class SpocController extends Controller
{
    ...
    public function storeAssign(Request $request)
    {
        try {
            $request->validate([
                ...
                'state' => 'required',
                'district' => 'required|string', // Change to string as it will be exploded
            ]);
    ...
    public function storeVendor(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'email' => 'required|email|max:255|unique:vendorusers,email', // Ensure email uniqueness in vendorusers table
