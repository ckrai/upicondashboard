...
<head>
  ...
  <title>Mission Shakti | Coordinator List</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="add_coordinator.php" class="nav-link"><button type="button" class="btn btn-block bg-gradient-primary">Add New</button></a>
            </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                        $user = new User();
                        $result = $user->get_coordinator_list();
                        $i=0;
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <!-- <td><img class="direct-chat-img" src="../app-assets/dist/img/user2-160x160.jpg" alt="Message User Image"></td> -->
