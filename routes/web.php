...
Route::group(['prefix' => 'director'], function () {
    ...
    // Route::get('/', 'DirectorController@index')->name('director.list');
    Route::get('/edit/{id}', 'DirectorController@edit')->name('director.edit');
    Route::post('/edit/{id}', 'DirectorController@update')->name('director.update');
...
Route::group(['prefix' => 'vertical'], function () {
    ...
    Route::get('/edit/{id}', 'VerticalController@edit')->name('vertical.edit');
    Route::post('/edit/{id}', 'VerticalController@update')->name('vertical.update');
    Route::get('/view/{id}', 'VerticalController@show')->name('vertical.view');
...
Route::group(['prefix' => 'spoc'], function () {
    ...
    Route::get('/edit/{id}', 'SpocController@edit')->name('spoc.edit');
    Route::post('/edit/{id}', 'SpocController@update')->name('spoc.update');
    Route::get('/view/{id}', 'SpocController@show')->name('spoc.view');
...
Route::group(['prefix' => 'team'], function () {
    ...
    Route::post('/edit/{id}', 'TeamController@update')->name('team.update');
    Route::get('/view/{id}', 'TeamController@show')->name('team.view');
...
Route::group(['prefix' => 'vendor'], function () {
    ...
    Route::post('/edit/{id}', 'VendorController@update')->name('vendor.update');
    Route::get('/view/{id}', 'VendorController@show')->name('vendor.view');
    Route::get('/profile', 'VendorController@profileA')->name('vendor.profileAll');
...
Route::group(['prefix' => 'beneficiary'], function () {
    ...
    Route::get('/view/{id}', 'BeneficiaryController@show')->name('beneficiary.view');
    Route::get('/viewPDF/{id}', 'BeneficiaryController@showPDF')->name('beneficiary.viewPDF');
});
