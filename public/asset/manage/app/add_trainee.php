...
<html lang="en">
   <head>
      ...
      <title>Mission Shakti | Add Trainees </title>
   ...
   <body class="hold-transition sidebar-mini">
            ...
            <section class="content">
               ...
               <div class="container">
                  ...
                  <div class="card card-default">
                     ...
                     <!-- /.card-header -->
                     <form id="trainees_form">
                        <div class="card-body">
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Event</label>
                                    <select class="form-control select2" name="event" id="event" style="width: 100%;">
                                       <option value="">Select Event</option>
                                       <?php
                                          $user = new User();
                                          $result = $user->get_event();
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label>Aadhar</label>
                                    <input type="text" class="form-control" id="aadhar" name="aadhar" placeholder="Enter aadhar">
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
      ...
      <script type="text/javascript" language="javascript" >
         $(document).ready(function(){
          $('#trainees_form')[0].reset();
             $(document).on('submit', '#trainees_form', function(e){
                 e.preventDefault();
                  $("#spinner-div").show(); 
                    var event        = $('#event').val();
                    var name         = $('#name').val();
                 ...
                 if(event != '' && name != ''  && mobile != '' && email != '' && aadhar != '' && district != '' && organisation != ''  && address != '' )
                 {
                     $.ajax({
                         url:"action/add-trainees",
                         method:'POST',
