  ...
  <section class="content">
    <div id="formContent">
      <div class="fadeIn first">
        <img src="{{ url('dist/img/bupb.png') }}" id="icon" alt="User Icon" />
        <h1>Baroda Uttar Pradesh Bank Commission</h1>
      </div>
      <!-- Login Form -->
      <form action="{{ route('openuser.showBUPB') }}" method="GET">
        <input type="text" id="" class="fadeIn second" name="VLE_ID" placeholder="के. ओ. कोड दर्ज  करें।...उदाहरण (13130071)">
        <input type="text" id="" class="fadeIn second" name="pan_card" placeholder="पैन नंबर दर्ज करें">
