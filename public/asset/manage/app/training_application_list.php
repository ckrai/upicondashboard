...
<head>
  ...
  <title>Mission Shakti | Training Application List</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Training Application List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Training Application List</h3>
                  ...
                  <tbody>
                    <?php
                      ...
                      if(isset($_GET['district']) && !empty($_GET['district'])){
                        $result = $application->get_district_training_application($_GET['district']);
                      }
                      else{
                        $result = $application->get_training_application();
                      }
