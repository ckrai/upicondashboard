...
<?php
// API URL
$api_url = "http://65.0.61.109/stream/list_channels";
...
<head>
  ...
  <title>Mission Shakti | Channel List</title>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>
                      ...
                      <!-- <a href="https://upmissionshakti.in/live-video-player?playback_url=<?php echo $channel['playback_url'];?>" class="btn btn-tbl-edit btn-xs btn-primary"> -->
