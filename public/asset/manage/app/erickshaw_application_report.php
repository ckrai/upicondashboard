...
<head>
  ...
  <title>Mission Shakti | E-Rickshaw Application Report</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> E-Rickshaw Application Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">E-Rickshaw Application Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      ...
                      $result = $application->get_ev_application_report();
                      $i=0;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="erickshaw_application_list?district=<?php echo $row['district'];?>" class="btn btn-tbl-edit btn-xs btn-primary">
