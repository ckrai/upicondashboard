...
<head>
  ...
  <title>Mission Shakti | Live Channel List</title>
                  ...
                  <tbody>
                      <?php
                       ...
                       <tr>
                         ...
                         <td><strong><?php echo $tags['event_name']; ?></strong>(<?php echo $tags['event_id']; ?>)</td>
                         <td><?php echo $tags['district'];?></td>
                         <td><?php echo $channel['playback_url'];?></td>
                    ...
                    <td>
                      ...
                      <a href="https://upmissionshakti.in/aws-live-video-player?playback_url=<?php echo $channel['playback_url'];?>" class="btn btn-tbl-edit btn-xs btn-primary">
