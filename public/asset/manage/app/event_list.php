...
<head>
  ...
  <title>Mission Shakti | Event List</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="event_add.php" class="nav-link"><button type="button" class="btn btn-block bg-gradient-primary">Add New</button></a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      ...
                      if(isset($_GET['district']) && !empty($_GET['district'])){
                        $result = $event->get_district_event_list($_GET['district']);
                      }
                      else{
                        $result = $event->get_event_list();
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="#view_student<?php echo $row['id'];?>" data-target="#view_student<?php echo $row['id'];?>" data-toggle="modal"  class="btn btn-tbl-edit btn-xs btn-primary">
...
<script type="text/javascript" language="javascript" >
   // Enable/Disable Tender.
                $('.active').click(function(){
                    ...
                    // AJAX request
                    $.ajax({
                        url: 'action/event_status_update',
                        type: 'post',
                        data: {event_id: event_id, active: active, request: 1},
