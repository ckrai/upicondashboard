                ...
                <div class="card">
                    <div class="card-body">
                        <form id="regForm" action="{{ route('vertical.saveProject') }}" method="post"
                            ...
                            <input type="number" hidden id="vertical_id" name="vertical_id"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <font style="color:red">{{ $errors->has('p_name') ? $errors->first('p_name') : '' }}
                                    </font>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea type="text" class="form-control" row='6' id='p_details' name="p_details"
