...
<head>
  ...
  <title>Mission Shakti | Supervisor List</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="add_supervisor.php" class="nav-link"><button type="button" class="btn btn-block bg-gradient-primary">Add New</button></a>
            </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                        $user = new User();
                        $result = $user->get_supervisor_list();
                        $i=0;
