...
<?php include 'action/class/trainee-class.php'; ?>
...
<head>
  ...
  <title>Mission Shakti | Trainee Report</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      $application = new Trainee();
                      $result = $application->get_trainee_report();
                      $i=0;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="trainee_list?district=<?php echo $row['district'];?>" class="btn btn-tbl-edit btn-xs btn-primary">
