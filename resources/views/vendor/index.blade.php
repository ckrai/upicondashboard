              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td >{{ $user->status }}</td>
                    <!--  <td>
                      <a href="{{ route('vendor.edit', $user->id) }}" class="btn btn-sm btn-outline-danger py-0">Edit</a>
                      <a href="{{ route('vendor.view', $user->id) }}" class="btn btn-sm btn-outline-success py-0">View</a>
                    </td> -->
                    </tr>
                    @empty
